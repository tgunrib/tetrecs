...
public class GameWindow {
    ...
    public void startAnimation() {
        loadScene(new IntroductionScene(this));
    }
    ...
    /**
     * Display the socreboard
     */
    public void startScores(){ loadScene(new ScoresScene(this));}

    /**
     * Display the lobbyscene
     */
    public void startMultiplayer(){loadScene(new LobbyScene(this));}

    /**
     * Display the MultiplayerScene
     * @return
     */
    public MultiplayerScene startMultiplayerGame(){
        MultiplayerScene scene = new MultiplayerScene(this);
        loadScene(scene);
        return scene;
    }

    /***
     * Method to display a multiplayer score scene
     * @param board
     */
    public void startMultiplayerScoreScene(LeaderBoard board){
        loadScene(new MultiplayerScoreScene(this,board));
    }
